...
public class CafeService {
    ...
    public void addCoffeeType(MenuParams menuParams) {
        Cafe cafe = cafeRepository.get();
        CoffeeType coffeeType = new CoffeeType(menuParams.name(), menuParams.cost(), menuParams.recipe(), false);
        cafe.addCoffeeType(coffeeType);
        cafeRepository.saveOrUpdate(cafe);
    }
}
