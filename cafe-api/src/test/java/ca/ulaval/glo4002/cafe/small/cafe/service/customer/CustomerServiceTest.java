...
public class CustomerServiceTest {
    ...
    private static final Coffee AN_AMERICANO_COFFEE = new Coffee(new CoffeeName("Americano"));
    private static final Coffee A_DARK_ROAST_COFFEE = new Coffee(new CoffeeName("Dark Roast"));
    ...
    public void whenPlacingOrder_shouldGetCafe() {
        customersService.placeOrder(new CustomerOrderParams(CUSTOMER_ID.value(), List.of("Americano")));
